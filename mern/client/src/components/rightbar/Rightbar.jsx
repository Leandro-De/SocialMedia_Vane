      ...
      <>
        <div className="birthdayContainer">
          ...
          <span className="birthdayText">
            <b>Pola Fierro</b> y <b>3 amigos más</b> estan de cumpleaños.
          </span>
        </div>
        <br />
        <h4 className="rightbarTitle">En linea</h4>
    ...
    return (
      <>
        ...
        <div className="rightbarInfo">
          ...
          <div className="rightbarInfoItem">
            <span className="rightbarInfoKey">Sucursal:</span>
